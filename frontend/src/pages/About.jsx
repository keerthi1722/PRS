...
export default function About() {
    ...
    return (
        <div className="bg-[#F5F7FA] min-h-screen">
            ...
            {/* ================= CTA ================= */}
            <div className="px-4 md:px-16 mt-8 mb-10">
                <div className="bg-[#0A2540] text-white rounded-xl px-4 md:px-10 py-5 flex flex-col md:flex-row justify-between items-center gap-4 md:gap-0">

                    <div className="flex items-center gap-4 text-center md:text-left">
                        <div className="bg-[#D4AF37] p-3 rounded-full">📞</div>
                        ...
                        <div>
                            ...
                            <p className="text-sm text-gray-300">
                                Join PRS Career Crafts and take the first step toward your dream career.
                            </p>
                        </div>
                    </div>
