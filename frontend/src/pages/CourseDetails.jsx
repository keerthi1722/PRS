...
export default function CourseDetails() {
    ...
    const handleRegister = async () => {
        ...
        try {
            await axios.post("http://localhost:5001/api/courses/register", {
                name,
                email,
                phone,
                course: course.title,
    ...
    return (
        <div className="bg-[#F5F7FA] min-h-screen flex flex-col">
            ...
            {/* ================= FOOTER ================= */}
            <div className="bg-[#0A2540] text-white mt-auto">
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 px-4 md:px-10 py-10">
                    <div>
                        ...
                        <p className="text-sm text-gray-300 mt-3">
                            Shaping careers with expert training.
                        </p>
                    </div>

                    <div>
                        <h3 className="text-[#D4AF37] mb-3">Explore</h3>
                    ...
                    <div>
                        <h3 className="text-[#D4AF37] mb-3">Contact</h3>
                        <p>LB Nagar, Hyderabad</p>
                        <p>+91 99999 99999</p>
                    </div>

                    <div>
                        <h3 className="text-[#D4AF37] mb-3">Newsletter</h3>
                        <input className="w-full p-2 text-black rounded mb-2" placeholder="Email" />
                        <button className="bg-[#D4AF37] px-4 py-2 rounded">
                            Join
                        </button>
                    </div>
                </div>

                <div className="text-center text-sm py-3 border-t border-gray-600">
                    © 2026 PRS Career Crafts
                </div>
            </div>
