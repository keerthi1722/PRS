...
export default function Placement() {
  ...
  {[
    ...
    >
      ...
      {/* ================= CTA ================= */}
      <div className="bg-[#FFF7E6] mx-4 md:mx-12 mt-10 rounded-xl px-4 md:px-10 py-6 flex flex-col md:flex-row justify-between items-start md:items-center gap-4 md:gap-0">
        ...
        <div>
          ...
          <p className="text-gray-600 mt-1">
            Join PKS Career Crafts today and take the first step.
          </p>
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-4 w-full md:w-auto">
          <button 
            ...
            className="bg-[#D4AF37] text-white px-6 py-2 rounded"
          >
            Explore Courses →
          </button>

          <button className="border border-[#0A2540] text-[#0A2540] px-6 py-2 rounded" onClick={() => setShowRegister(true)}>
            Register Now →
          </button>
        </div>
